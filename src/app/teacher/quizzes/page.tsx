...
export default function TeacherQuizzesRedirectPage() {
    ...
    <div className="min-h-[400px] flex items-center justify-center p-6 text-center">
      <div className="max-w-md w-full bg-white rounded-3xl p-8 border border-slate-200 shadow-xl space-y-4">
        ...
        <p className="text-xs text-slate-500">
          All lesson comprehension quizzes and Stage Final Milestone quizzes are authored directly in your Stage Badges Hub.
        </p>
